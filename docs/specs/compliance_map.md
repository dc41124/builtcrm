...
**Primary blocker for CA/EU launch:** user deletion + data export flows. See [security_posture.md §6](security_posture.md#6-known-gaps-post-baseline-backlog) backlog.
