...
import { editDraft } from "@/domain/actions/time-entries";
...
// PATCH /api/time-entries/[id] — worker edits one of their own draft rows.
// Submitted+ rows are read-only here; admin must use /amend.
