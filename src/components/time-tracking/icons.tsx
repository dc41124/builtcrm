// Inline SVG icons used by the time-tracking shells. Lifted from the
// prototype's `I` map. Centralized here so both worker and admin shells
// import the same set without duplication.

export const TtIcons = {
  play: (
...
export function ProjectChip({
  ...
  return (
    <span className={`tt-project-chip${size === "sm" ? " sm" : ""}`}>
      {size !== "sm" && TtIcons.building}
      <span>{name}</span>
    </span>
  );
}
